			...
			<div class="row">
				<div class="col-lg-6">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							<label for="firebase_api">Firebase Server API Key: 'AAAAIKkmOYU:APA91bH5BnJXPbyFDVpZn2DpWFORZAOzbFdErEkOa5gCxmFlPCQJjL6HW5vSObiyBksGjc1FdjC2QIh0nd-PTbapybJCiTMPoGJgO7_T72D6YKmkNXSpsLr4HPLH5YMtWHRy9HXiFKm5' </label>
